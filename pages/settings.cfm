...
<cfoutput>
 <div>
  ...
  <form autocomplete="on" action="SaveAddUsers.cfm" method="post">
...
<td>
<input type="button" onclick="location.href='settings.cfm?teamUserId=#qUsers.TeamUserId#'" value="Edit" class="inputfld">
</td>
</tr>
</cfoutput>
</table>
