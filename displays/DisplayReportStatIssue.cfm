...
<cfelse>
			...
			<form action="#application.displays#DisplayReportStatIssue.cfm" method="post">
			<cfoutput>
				...
				<tr class="row-odd">
					<td style="text-align: left;">
						<b>Note: You must be logged in to report an issue.</b>
								...
								<td align="center">
					<input type="button" value="Login" onclick="location.href='#application.pages#authenticate.cfm'">
					</td>
				</cfoutput>
				</cfif>					
