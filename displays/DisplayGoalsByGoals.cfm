...
<cfquery dbtype="query" name="qJustGoals">
 ...
 <cfif len(attributes.filterBy) gt 0>
	...
	<table class="table-container" align="left" class="center" style="width:100%" cellspacing=0>	
			<cfloop query="qJustGoals">
				...
				<tr>
					...
					<td class="#classValue#">
<img src="assets/images/HockeyIcons/#TeamIcon#" width="75">
				</td>
...
<cfif qStatsPlusMinus.recordcount gt 0> 
					...
					<td valign="top" class="#classValue#" align="center">
						<div style="margin-top: 20px;margin-bottom: 20px;">
						<cfif VideoURL is not "">
							<iframe width="320" height="180" src="#VideoURL#" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen>
							</iframe>
				...
				<cfelse>
					<img src="assets/images/HockeyIcons/NoVideo.png" width="220">
				</cfif>
							</div>
				</td>
