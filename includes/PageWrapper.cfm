...
<cfset attributes.showNavBar=attributes.showHeader>
...
<header class="header-banner">
  <div class="nav-cell logo" style="text-align: left;">
    <a href="index.cfm" tabindex="-1">
      <img src="assets/images/HockeyIcons/MyFreeHockeyStatsNew.png" alt="My Free Hockey Stats" width="300" tabindex="-1"
    </a>
  </div>
